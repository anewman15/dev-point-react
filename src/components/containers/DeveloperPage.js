  ...
  return (
    <div className="page-container bg-gray-50 page-border page-shadow">
          ...
          <div className="">
            ...
            <div className="my-3">
              <h2 className="text-xl text-gray-800 font-semibold">
                ...
                { currentDev.employments && currentDev.employments.length ? `${currentDev.employments[0].title}` : null}
              </h2>
              <h3 className="text-gray-800">
                <span className="text-gray-300 mr-2"><i className="fas fa-building" /></span>
                { currentDev.employments && currentDev.employments.length ? `${currentDev.employments[0].company_name}` : null }
              </h3>
      ...
      <div className="mx-auto flex flex-col justify-center lg:flex-row lg:justify-start items-center lg:space-x-4">
        ...
        {
          currentDev.skills && currentDev.skills.length
            ? (
